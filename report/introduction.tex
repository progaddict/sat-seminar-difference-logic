...
The given above algorithm is quite generic, it is more of a template.
...
As mentioned in~\cite{cotton2004some, mahfoudh2003verification} 
According to the main article, they are:
\begin{itemize}
