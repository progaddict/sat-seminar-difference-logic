...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{figure}[htb]
            ...
            \node [block, left = 1cm of admissibleEdges, text width=5cm, align=center] (applyGR) {Apply the next pass $ \Rightarrow $ update distance estimates and rebuild $ \Gamma_d $};
