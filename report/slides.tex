...
\usepackage{tikz}
\usetikzlibrary{arrows.meta,decorations.pathmorphing,positioning,fit,trees,shapes}
...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \textcolor{blue}{linear arithmetic logic},
    ...
    \begin{frame}
        ...
        \begin{figure}[htb]
            ...
            \draw[-{Latex[length=3mm]}] (formula) -- (BCP);
            \draw[-{Latex[length=3mm]}] (BCP) -- node[anchor=south] {conflict} (unsat);
            \draw[-{Latex[length=3mm]}] (BCP) -- (decide);
            \draw[-{Latex[length=3mm]}] (decide) -- node[anchor=south] {all variables are set} (sat);
            \draw[-{Latex[length=3mm]}] (decide) -- node[anchor=west] {set next variable} (BCP2);
            \draw[-{Latex[length=3mm]}] (BCP2) -- node[anchor=north] {conflict} (resolve);
            \draw[-{Latex[length=3mm]}] (BCP2) edge[bend left=90] node[anchor=east] {no conflict} (decide);
            \draw[-{Latex[length=3mm]}] (resolve) edge[bend right=30] node[anchor=west] {cannot resolve} (unsat);
            \draw[-{Latex[length=3mm]}] (resolve) edge[bend left=90] node[anchor=north] {can resolve} (BCP2);
            \end{tikzpicture}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}[htb]
            \resizebox {0.55\linewidth} {!} {
                ...
                \draw[-{Latex[length=3mm]}] (dl) -- node[anchor=east, name=substitution] {$ x - y \prec c \eqbydef p_{xyc} $} (pl);
                \draw[-{Latex[length=3mm]}] (pl) -- (sat-solver);
                \draw[-{Latex[length=3mm]}] (substitution) edge[bend right=70] node[anchor=south, sloped] {mapping} (theory-solver);
                \draw[-] (sat-solver.west) edge[bend right=50] node[anchor=south east] {SAT} (model);
                \draw[-{Latex[length=3mm]}] (model) edge[bend right=20] (theory-solver);
                \draw[-{Latex[length=3mm]}] (sat-solver) -| node[anchor=south east] {UNSAT} (unsat);
                \draw[-] (theory-solver) edge[bend right=30] node[anchor=south east] {UNSAT} (explanation);
                \draw[-{Latex[length=3mm]}] (explanation) edge[bend right=20] (sat-solver);
                \draw[-{Latex[length=3mm]}] (theory-solver) |- node[anchor=south east] {SAT} (sat);
                \end{tikzpicture}
            }
    ...
    \begin{frame}
        ...
        \begin{figure}[htb]
            \resizebox {0.55\linewidth} {!} {
                ...
                \draw[-] (sat-solver.west) edge[bend right=50] node[anchor=south east] {SAT} (model);
                \draw[-{Latex[length=3mm]}] (model) edge[bend right=20] (theory-solver);
                \draw[-{Latex[length=3mm]}] (sat-solver) -| (unsat);
            ...
            \begin{column}{.4\textwidth}
                \begin{figure}[htb]
                    \resizebox {1.2\linewidth} {!} {
                        ...
                        \draw[-{Latex[length=3mm]}] (u) -- node[anchor=south] {1} (v);
                        \draw[-{Latex[length=3mm]}] (v) -- node[anchor=south] {5} (w);
                        \draw[-{Latex[length=3mm]}] (w) -- node[anchor=east] {-3} (x);
                        \draw[-{Latex[length=3mm]}] (x) -- node[anchor=north] {1} (y);
                        \draw[-{Latex[length=3mm]}] (y) -- node[anchor=north] {-5} (z);
                        \draw[-{Latex[length=3mm]}] (y) -- node[anchor=east] {0} (v);
                        \end{tikzpicture}
            ...
            \begin{column}{.4\textwidth}
                \begin{figure}[htb]
                    \resizebox {1.2\linewidth} {!} {
                        ...
                        \draw[-{Latex[length=3mm]}] (u) -- node[anchor=south] {1} (v);
                        \draw[-{Latex[length=3mm]}] (v) -- node[anchor=south] {5} (w);
                        \draw[-{Latex[length=3mm]}] (w) -- node[anchor=west] {\textcolor{red}{-3}} (x);
                        \draw[-{Latex[length=3mm]}] (x) -- node[anchor=north] {\textcolor{red}{-3}} (y);
                        \draw[-{Latex[length=3mm]}] (y) -- node[anchor=north] {-5} (z);
                        \draw[-{Latex[length=3mm]}] (y) -- node[anchor=east] {\textcolor{red}{4}} (w);
                        \end{tikzpicture}
                    }
                \end{figure}
                \begin{equation*}
    ...
    \begin{frame}
        ...
        \begin{figure}[htb]
            ...
            \draw[-{Latex[length=3mm]}] (x2) -> (x3);
            \draw[-{Latex[length=3mm]}] (x3) -> (x4);
            \draw[-{Latex[length=3mm]}] (x4) -> (x5);
            ...
            \draw[-{Latex[length=3mm]}] (x10) -> (x9);
            \draw[-{Latex[length=3mm]}] (x9) -> (x8);
            \draw[-{Latex[length=3mm]}] (x8) -> (x7);
            \draw[-{Latex[length=3mm]}] (x7) -> (x6);
            
            \draw[-{Latex[length=3mm]}] (x5) -> (x10);
            \draw[-{Latex[length=3mm]}] (x10) -> (x4);
            \draw[-{Latex[length=3mm]}] (x4) -> (x9);
            \draw[-{Latex[length=3mm]}] (x3) -> (x9);
            \draw[-{Latex[length=3mm]}] (x3) -> (x8);
            \draw[-{Latex[length=3mm]}] (x8) -> (x2);
            \draw[-{Latex[length=3mm]}] (x2) -> (x7);
            \draw[-{Latex[length=3mm]}] (x1) -> (x7);
            \draw[-{Latex[length=3mm]}] (x6) -> (x1);
            ...
            \draw[-{Latex[length=3mm]}] (x11) -> (x12);
            \draw[-{Latex[length=3mm]}] (x12) -> (x13);
            \draw[-{Latex[length=3mm]}] (x13) -> (x14);
            \draw[-{Latex[length=3mm]}] (x14) -> (x15);
            
            \draw[-{Latex[length=3mm]}] (x6) -> (x11);
            \draw[-{Latex[length=3mm]}] (x11) -> (x7);
            \draw[-{Latex[length=3mm]}] (x12) -> (x7);
            \draw[-{Latex[length=3mm]}] (x7) -> (x13);
            \draw[-{Latex[length=3mm]}] (x8) -> (x13);
            \draw[-{Latex[length=3mm]}] (x9) -> (x13);
            \draw[-{Latex[length=3mm]}] (x14) -> (x9);
            \draw[-{Latex[length=3mm]}] (x10) -> (x14);
            \draw[-{Latex[length=3mm]}] (x15) -> (x10);
            \end{tikzpicture}
        \end{figure}
        \begin{itemize}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item Note: the algorithm runs
                \textcolor{blue}{once for the whole graph},
            ...
            \begin{column}{.48\textwidth}
                \begin{figure}[htb]
                    \resizebox {\linewidth} {!} {
                        ...
                        \draw[-{Latex[length=3mm]}] (s) -- node[anchor=south] {1} (x1);
                        \draw[-{Latex[length=3mm]}] (x1) -- node[anchor=south] {5} (x2);
                        \draw[-{Latex[length=3mm]}] (x2) -- node[anchor=east] {-3} (x3);
                        \draw[-{Latex[length=3mm]}] (x3) -- node[anchor=north] {-1} (x4);
                        \draw[-{Latex[length=3mm]}] (x4) -- node[anchor=north] {-5} (x5);
                        \draw[-{Latex[length=3mm]}] (x4) -- node[anchor=east] {-2} (x1);
                        \end{tikzpicture}
                    }
                \caption{$ \Gamma $}
                \end{figure}
            ...
            \begin{column}{.48\textwidth}
                \begin{figure}[htb]
                    \resizebox {\linewidth} {!} {
                        ...
                        \draw[-{Latex[length=3mm]}] (s) -- node[anchor=south] {0} (x1);
                        \draw[-{Latex[length=3mm]}] (x1) -- node[anchor=south] {0} (x2);
                        \draw[-{Latex[length=3mm]}] (x2) -- node[anchor=east] {0} (x3);
                        \draw[-{Latex[length=3mm]}, color=blue] (x3) -- node[anchor=north] {$ -\infty $} (x4);
                        \end{tikzpicture}
                    }
                    \caption{$ \Gamma_d $}
                \end{figure}
    ...
    \begin{frame}
            ...
            \begin{column}{.48\textwidth}
                \begin{figure}[htb]
                    \resizebox {\linewidth} {!} {
                        ...
                        \draw[-{Latex[length=3mm]}] (x1) -- node[anchor=south] {0} (x2);
                        \draw[-{Latex[length=3mm]}] (x2) -- node[anchor=east] {0} (x3);
                        \draw[-{Latex[length=3mm]}, color=blue] (x3) -- node[anchor=north] {$ \textcolor{blue}{0} $} (x4);
                        \draw[-{Latex[length=3mm]}, color=blue] (x4) -- node[anchor=north] {$ \textcolor{blue}{-\infty} $} (x5);
                        \draw[-{Latex[length=3mm]}, color=blue] (x4) -- node[anchor=east] {\textcolor{blue}{-1}} (x1);
                        \end{tikzpicture}
                    }
                    \caption{$ \Gamma_d $}
                \end{figure}
        ...
        \begin{center}
            \begin{tabular}{c c c}
                $ r(s,x_1) = 0 $ & $ r(x_1,x_2) = 0 $ & $ r(x_2,x_3) = 0 $ \\
                $ \textcolor{blue}{r(x_3,x_4) = 0} $ & $ \textcolor{blue}{r(x_4,x_1) = -1} $ & $ \textcolor{blue}{r(x_4,x_5) = -\infty} $ \\
            \end{tabular}
        \end{center}
        Now $ \Gamma_d $ has a cycle:
        \textcolor{blue}{$ x_1 \rightarrow x_2 \rightarrow x_3 \rightarrow x_4 \rightarrow x_1 $}
        and this cycle corresponds to the negative cycle
        in $ \Gamma $.
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}[htb]
            ...
            \draw[-{Latex[length=3mm]}] (formula) -- (cg);
            \draw[-{Latex[length=3mm]}] (cg) -- (init1);
            \draw[-{Latex[length=3mm]}] (init1) -- (checkCycle);
            \draw[-{Latex[length=3mm]}] (checkCycle) -- node[anchor=south] {yes} (hasCycle);
            \draw[-{Latex[length=3mm]}] (checkCycle) -- node[anchor=south] {no} (admissibleEdges);
            \draw[-{Latex[length=3mm]}] (hasCycle) -- node[anchor=west] {yes} (unsat);
            \draw[-{Latex[length=3mm]}] (hasCycle) -- node[anchor=west] {no} (admissibleEdges);
            \draw[-{Latex[length=3mm]}] (admissibleEdges) -- node[anchor=west] {yes} (sat);
            \draw[-{Latex[length=3mm]}] (admissibleEdges) -- node[anchor=south] {no} (applyGR);
            \draw[-{Latex[length=3mm]}] (applyGR) -- (checkCycle);
            \end{tikzpicture}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            by a constraint graph \textcolor{blue}{$ \Gamma $}.
            \begin{itemize}
                \item A negative cycle corresponds to a conflict \\
                \eg \textcolor{blue}{$ 0 < -3 $},
                \textcolor{blue}{$ 0 \le -1 $},
                \textcolor{blue}{$ 0 < -5 $} \etc
                \item A zero weight cycle with a
                \textcolor{blue}{strict inequality} edge \\
                corresponds to a conflict \textcolor{blue}{$ 0 < 0 $}.
            \end{itemize}
            \item Bellman-Ford algorithm in combination with
            \textcolor{blue}{$ \Gamma_d $}
            can be used to detect these conflicting cycles.
            \begin{itemize}
                \item A cycle in \textcolor{blue}{$ \Gamma_d $}
                corresponds to a conflicting cycle in
                \textcolor{blue}{$ \Gamma $}.
            \end{itemize}
        \end{itemize}
    \end{frame}
            ...
            \begin{column}{.4\textwidth}
                \begin{figure}[htb]
                    \resizebox {1.33\linewidth} {!} {
                        ...
                        \draw[-{Latex[length=3mm]}] (x) edge[bend left=45] node[anchor=south] {$ 1 $} (y);
                        \draw[-{Latex[length=3mm]}] (y) edge[bend left=45] node[anchor=south] {$ 2 $} (z);
                        \draw[-{Latex[length=3mm]}] (z) edge[bend left=45] node[anchor=south] {$ 3 $} (x);
                        \draw[-{Latex[length=3mm]}] (x) -- node[anchor=south] {$ 4 $} (z);
                        \draw[-{Latex[length=3mm]}] (z) -- node[anchor=south] {$ 5 $} (y);
                        \draw[-{Latex[length=3mm]}] (y) -- node[anchor=south] {$ 6 $} (x);
                        \end{tikzpicture}
                    }
                \end{figure}
                \begin{itemize}
    ...
    \begin{figure}[htb]
        ...
        \draw[-{Latex[length=3mm]}] (p) -- (r);
        \draw[-{Latex[length=3mm]}] (p) -- (s);
        \draw[-{Latex[length=3mm]}] (r) -- (q);
        \draw[-{Latex[length=3mm]}] (q) -- (t);
        \draw[-{Latex[length=3mm]}] (t) -- (r);
        \draw[-{Latex[length=3mm]}] (s) -- (u);
        \draw[-{Latex[length=3mm]}] (s) -- (v);
        \draw[-{Latex[length=3mm]}] (r) -- (s);
        \end{tikzpicture}
    \end{figure}
    \vfill
    \begin{center}
    ...
    \begin{figure}[htb]
        ...
        \draw[-{Latex[length=3mm]}] (q) -- (t);
        \draw[-{Latex[length=3mm]}] (t) -- (r);
        \draw[-{Latex[length=3mm]}, color=blue] (s) -- (u);
        \draw[-{Latex[length=3mm]}, color=blue] (s) -- (v);
        \draw[-{Latex[length=3mm]}] (r) -- (s);
        \end{tikzpicture}
    \end{figure}
    \vfill
    ...
    \begin{figure}[htb]
        ...
        \draw[-{Latex[length=3mm]}] (p) -- (r);
        \draw[-{Latex[length=3mm]}] (p) -- (s);
        \draw[-{Latex[length=3mm]}, color=blue] (r) -- (q);
        \draw[-{Latex[length=3mm]}, color=blue] (q) -- (t);
        \draw[-{Latex[length=3mm]}, color=blue] (t) -- (r);
        \draw[-{Latex[length=3mm]}, color=blue] (r) -- (s);
        \end{tikzpicture}
    \end{figure}
    \vfill
    \begin{center}
