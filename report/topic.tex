...
\begin{itemize}
    \item $ \phi $ is a conjunction of some DL constraints
    which is being checked for SAT.
    \item $ (x - y \prec c) \in \phi $ is a general form
    of a DL constraint where $ \prec \; \in \{ <, \leq \} $.
...
in a constraint graph and the SAT of the corresponding
conjunction of DL constraints $ \phi $ represented by this graph.
