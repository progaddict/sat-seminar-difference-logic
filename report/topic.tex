...
\begin{theorem}
    ...
    \begin{proof}
        ...
        Since we do not have cycles in $ \Gamma_d $,
        ...
        Therefore the edge $ (x,y) $ will be updated finitely many
        times.
        Thus, at some iteration $ r(x,y) $ will become zero
        ...
        including the edges of $ Z $ cannot be relaxed:
        \begin{equation}
